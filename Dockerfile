...
RUN apk -U upgrade \
    ...
    && wget -q https://releases.hashicorp.com/terraform/${TERRAFORM_VERSION}/terraform_${TERRAFORM_VERSION}_${TARGETOS}_${TARGETARCH}.zip | unzip -p - >  /usr/local/bin/terraform \
